...
const typeResolversDecoration = ['/* TYPE RESOLVERS */']
...
export const generateTSTypesAsString = async (
  ...
  if (mergedOptions.generateResolverTypes) {
    let typeResolvers: GenerateResolversResult = {
      body: [],
      importHeader: []
    }
    ...
    header = [...header, ...typeResolvers.importHeader]

    body = [...body, ...typeResolversDecoration, ...typeResolvers.body]
  }

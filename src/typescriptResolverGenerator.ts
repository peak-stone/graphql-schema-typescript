    ...
    this.resolverInterfaces.push(
      ...[
        ...
        `(parent: TParent, context: ${
          this.contextType
        }, info: GraphQLResolveInfo): ${possbileTypes.join(' | ')};`,
        '}'
      ]
    )
    ...
    objectType.fields.forEach(field => {
      ...
      const fieldResolverTypeDef = !isSubscription
        ? [
            ...
            `(parent: TParent, args: ${argsType}, context: ${
              this.contextType
            }, info: GraphQLResolveInfo): ${returnType}`,
            '}',
            ''
          ]
        : [
            ...
            `subscribe: (parent: TParent, args: ${argsType}, context: ${
              this.contextType
            }, info: GraphQLResolveInfo) => ${subscriptionReturnType}`, // tslint:disable-line max-line-length
            '}',
            ''
          ]
